...
SRC        := src/service/pcm.c src/core/fixedrc.c src/core/rc_coeffs.c src/core/dp_param.c src/core/dp_wrapper.c src/pump/b103/b103.c src/dsp/fpm_sqrt.c src/dsp/fpm_phasor.c src/dsp/fpm_tone.c src/dsp/fpm_rms.c src/dsp/fpm_div.c src/dsp/fpm_mrf.c src/dsp/fpm_fsm.c src/dsp/fpm_tone_cfg.c src/dsp/fpm_fsd.c src/dsp/fpm_mtd.c src/dsp/fpm_mtd_cfg.c src/dsp/fpm_iir.c src/dsp/fpm_iir_coeffs.c src/dsp/fp_math.c src/dsp/fpm_agc.c src/pump/b103/b103_agc_cfg.c src/pump/b103/b103fp.c src/pump/b103/b103_cfg.c src/pump/b103/b103_tables.c src/callprog/callprog_status.c src/callprog/callprog_cfg.c src/callprog/callprog.c src/callprog/cpfiltrs.c src/callprog/toneiir.c src/callprog/dualtone.c src/callprog/callingtone.c src/callprog/cadence.c src/callprog/elliptic.c src/dialer/dialercfg.c src/dialer/dialer.c src/call/pulse.c src/call/call.c src/v8/v8util.c src/v8/v8v21.c src/v8/v8seq.c src/v8/v8hs.c src/v8/v8sig.c src/v8/v8agc.c src/v8/v8jm.c src/v8/v8dp.c src/v8/v8hsrx.c src/v8/v8handshak.c src/v8/v8proc.c src/pump/v23/v23filt.c src/pump/v23/v23tx.c src/pump/v23/v23rx.c src/pump/v23/bwchdem.c src/pump/v23/v23modem.c src/pump/v23/v23.c src/pump/v34/detector.c src/pump/v34/dftc.c src/pump/v34/dpsk.c src/pump/v34/v34filters.c src/pump/v34/v34rx.c src/pump/v34/v34shell.c src/pump/v34/v34hshak.c src/pump/v34/v34pcmif.c
...
TESTS      := t_pcm t_fixedrc t_fpm_sqrt t_rcresample t_dp_param t_dp_wrapper t_b103_reg t_fpm_phasor t_fpm_tone t_fpm_rms t_fpm_div t_fpm_mrf t_fpm_mrf_filter t_fpm_fsm t_fpm_fsd t_fpm_mtd t_fpm_iir t_fp_math t_fpm_agc t_b103fp t_b103hdx t_b103link t_b103alloc t_b103create t_b103dp t_toneiir t_callprog t_callprog_create t_dualtone t_callingtone t_cadence t_dialercfg t_dialer t_dialerprog t_callprog_progress t_call t_v8util t_v8sig t_v8jm t_v8dp t_v8hs t_pulse t_v23filt t_v23tx t_v23rx t_v23bwch t_v23modem t_v23dp t_v34det t_v34dft t_v34fsk t_v34ec t_v34eq t_v34rx t_v34shell t_v34hshak t_spandsp_replay
