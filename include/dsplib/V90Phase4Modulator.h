...
public:
	 ...
	 *
	 * NAMED (wave 3, F10138) BY THE SAME SIBLING-CLASS SYMMETRY THAT
	 ...
	 * Finding F7520 for the reader; F10138 for the name.
	 */
	 ...
	 * revisits MPNot.  NAMED (wave 3, F10138) DIRECTLY FROM THAT MESSAGE
