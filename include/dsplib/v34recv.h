 ...
 * their contents.
 *
 * NAMING PASS (F9480).  This header and `src/pump/v34/v34rx.c` carry the
 ...
 * in its comment as `-- derived: NAME, withheld (F9480)` for whoever next
...
struct v34_receiver {
	 ...
	 *
	 * -- derived: rxsymcnt, withheld (F9480): eleven references in
	 ...
	 *
	 * -- derived: pulls_per_call, withheld (F9480): seven references in
	...
	short           rms_idx;         /* +0x19c the cursor into `rms_buf[]`,
					  ...
					  mutation fixture (F9480). */
	/*
	 * +0x19e.  NOT "the RMS window's second scalar and nothing reads it
	 * back" -- that claim was wrong and is corrected here (F9480).
	 ...
	 *
	 * -- derived: retrain_gate, withheld (F9480): six references in
	 ...
	 * (f1b0), withheld (F9480): all three are written by
	 ...
	 *
	 * -- derived: mix_carrier_half_len, withheld (F9480): twenty-one
	 ...
	 *
	 * -- derived: interp_step_base, withheld (F9480): same blast radius
	 ...
	 * freeze bit above.
	 *
	 * -- derived: timing_state, withheld (F9480): three references in
	 ...
	 * parts per million.
	 *
	 * -- derived: ppm_offset, withheld (F9480): two references in
	 ...
	 * coincidence.
	 *
	 * -- derived: ppm_period, withheld (F9480): two references in
	 ...
	 *
	 * -- derived: timing_frac, withheld (F9480): one reference in
	 ...
	 *
	 * -- derived: eq_step, withheld (F9480): two references in
	 ...
	 *
	 * -- derived: equerr, withheld (F9480): `v34hstx1.cpp` inlines the
	 ...
	 *
	 * -- derived: eq_err_counter, withheld (F9480): one reference in
	 ...
	 *
	 * -- derived: equerr_acc (f220), withheld (F9480): same
	 * `v34hstx1.cpp`/fixture blast radius as f21a.
	 */
	int             f220;            /* +0x220 */
	/*
	 * -- derived: preerr, withheld (F9480): six references in
	 ...
	 *
	 * -- derived: agc_gain_init, withheld (F9480): nineteen references in
	 ...
	 *
	 * -- derived: subframe_count, withheld (F9480): one reference in
	 ...
	 *
	 * -- derived: fir_coeffs, withheld (F9480): four references in
