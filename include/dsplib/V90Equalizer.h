 ...
 * tools/cppstruct.py lists its destructor with the D1 and D2 variants and not
 * the deleting D0, and GCC emits a deleting destructor only for a virtual
 * class -- so offset 0 is a real member and there is no vptr to shift every
