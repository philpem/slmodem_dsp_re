...
- **Add independent standards oracles — fifteen numbered blocks complete.** F10249 consumes
  ...
  the caller/answer callback pairing. F10258 transcribes all 32 V.90 Table-15
  amplitudes and independently enumerates the Table-14 average over complete
  legal 2^15-codeword spaces. Both the table and mixed-radix weighting
