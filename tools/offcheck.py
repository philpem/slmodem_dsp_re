...
#
# `V90CPpck.h` is here for the first half of that reason ONLY: it declares two
# C++ functions over a forward-declared `class`, and defines no struct at all,
# so there is no layout for this tool to check and nothing is being excused.
#
...
#
SKIP_HEADERS = ("Agc.h", "ANSamToneDetector.h", "DiffCoder.h", "DILdescriptorPacker.h", "DspMath.h", "FloatARMA.h", "FloatFIR.h", "FloatIIR.h", "GenericIIR.h", "GenericToneDetector.h", "K56FlexFloModem.h", "LowPassFIR.h", "ModulusCoder.h", "Psd.h", "Queue.h", "Resampler.h", "ResamplerTiming.h", "ResamplerTimingOffset.h", "Scrambler.h", "SineWave.h", "V90AutoDigitalImpDetector.h", "V90BitsToSymbol.h", "V90ConnectionEvaluator.h", "V90ConstellationDesigner.h", "V90ConstellationPower.h", "V90CP.h", "V90CPpck.h", "V90Demapper.h", "V90Demodulator.h", "V90DilDescriptorSettings.h", "V90Equalizer.h", "V90Jd.h", "V90Mapper.h", "V90MappingParams.h", "V90Modem.h", "V90Modulator.h", "V90MP.h", "V90Parameters.h", "V90Phase2Info.h", "V90Phase3Demodulator.h", "V90Phase3Modulator.h", "V90Phase4Demodulator.h", "V90Phase4Modulator.h", "V90PreFilter.h", "V90RDetector.h", "V90Resampler.h", "V90SdDetector.h", "V90SessionFlag.h", "V90SignBitsExtractor.h", "V90SpectralShaper.h", "V90SpectralShapingFilter.h", "V90SpectralVerifier.h", "V90TRN2Designer.h", "V92BitsToSymbol.h", "V92ConvolutionEncoder.h", "V92CP.h", "V92EchoCanceller.h", "V92Ja.h", "V92Jd.h", "V92Mapper.h", "V92Modem.h", "V92Modulator.h", "V92ModulusEncoder.h", "V92Parameters.h", "V92Phase2Info.h", "V92Phase3Modulator.h", "V92Phase4Modulator.h", "V92Precoder.h", "V92PreFilter.h", "V92Transmitter.h", "VPcmFloModem.h", "x87copy.h")
