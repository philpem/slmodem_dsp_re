 ...
 * from 22 differing bytes to one.  Tables, macros and the two file-local
 * helpers live ABOVE every definition for the same reason -- the order is
 * going to be corrected again.  See docs/method/refinement.md lever 3.
 *
