/*
 * cid.c -- the Caller ID receiver core.  This is the blob's second `cid.c`
 * input, distinct from src/service/cid.c's three service wrappers.
 *
 * These functions are reconstructed from dsplibs.o's later `cid.c` FILE
 * record (finding F1410 for the TU map):
 *
