/*
 * Fdspkrnl.c -- the full-duplex speakerphone kernel.
 *
 * This file owns the kernel methods and their LOCAL state.  FDSP datapump
 * allocation is in Fdsp.c; the TONE_* helpers and ToneLPF are in TONE.c.
 *
