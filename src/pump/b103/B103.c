/*
 * B103.c -- translation-unit record placeholder, NOT reconstructed content.
 *
 * The reference object carries an `STT_FILE` record spelled `B103.c` between
 * `B103tab.c` and `B103prc.c`; the symbol-table run from the record to the
