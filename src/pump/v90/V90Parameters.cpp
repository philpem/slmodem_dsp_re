...
V90Parameters::setToDefault()
{
	...
	PDSNR_CURRENT_V34_DROP_THRESH_PHASE4 = 0x437a0000;	/* the object stores 250.0f here -- finding F878 */
	PHASE4_MEAN_ERROR_BEF_TO_AFT_UPDATE_RATIO_THRESH = 1.5f;
	QC_PHASE4_MEAN_ERROR_BEF_TO_AFT_UPDATE_RATIO_THRESH = 1.75f;
	PHASE4_MEAN_ERROR_BEF_TO_AFT_UPDATE_RATIO_THRESH_ALT_RBS = 10.0f;		/* 0x41200000 -- finding F878 */
	ENABLE_RRN_UP = 1;
	ENABLE_RRN_DOWN = 1;
