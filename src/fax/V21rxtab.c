/*
 * V21rxtab.c -- translation-unit record placeholder, NOT reconstructed
 * content.
 *
 * The reference object carries an `STT_FILE` record spelled `V21rxtab.c`
 * between `V21rx.c` and `V21tx.c`; the symbol-table run from the record to the
