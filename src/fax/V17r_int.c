/*
 * V17r_int.c -- ITU-T V.17 receiver processing, the run the object keeps in
 *              its own input file between V.29's transmitter and V.21's.
 *
 * This is the blob's V17r_int.c and was previously mis-named V17r_prc.c;
 * the receive state machine that the name belongs to is in the new
 * src/fax/V17r_prc.c.  See finding F11390.
 *
