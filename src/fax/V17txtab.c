/*
 * V17txtab.c -- translation-unit record placeholder, NOT reconstructed
 * content.
 *
 * The reference object carries an `STT_FILE` record spelled `V17txtab.c`
 * between `V17tx.c` and `V21rx.c`; the symbol-table run from the record to the
